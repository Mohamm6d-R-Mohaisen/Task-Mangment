<div class="tableActions">
    ...
    <a class="btn svg-icon" data-kt-docs-table-filter="delete_row" data-name="{{ $instance->name }}" data-action="{{route('admin.roles.destroy', $instance->id)}}" data-id="{{ $instance->id }}">
        <svg data-kt-docs-table-filter="delete_row" data-action="{{route('admin.roles.destroy', $instance->id)}}" xmlns="http://www.w3.org/2000/svg"
