										...
										<div class="col-xxl-5 col-xl-7 col-lg-8 col-sm-10 mx-auto">
											...
											<div class="card card-border">
												<div class="card-body">
													...
													<p class="p-xs mt-2 mb-4 text-center">Already a member ? <a href="{{route('login')}}"><u>Sign In</u></a></p>
													...
													<div class="row gx-3">
														<div class="form-group col-lg-6">
															...
															<input class="form-control" placeholder="Enter your name" value="" type="text" name="name">
														</div>
														<div class="form-group col-lg-6">
															<label class="form-label">Username</label>
															<input class="form-control" placeholder="Enter username" value="" type="text" name="username">
														</div>
														<div class="form-group col-lg-12">
															<label class="form-label">Email</label>
															<input class="form-control" placeholder="Enter your email id" value="" type="text" name="email">
														</div>
														<div class="form-group col-lg-12">
															<label class="form-label">Password</label>
															<div class="input-group password-check">
																<span class="input-affix-wrapper affix-wth-text">
																	<input class="form-control" placeholder="6+ characters" value="" type="password" name="password">
